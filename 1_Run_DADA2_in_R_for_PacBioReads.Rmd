---
title: "PIPE-2417_Stallion_microbiome (16S amplicon sequencing using PacBio reads) - DADA2 in R"
...
DADA2: A workflow for recovering single-nucleotide resolved Amplicon Sequence Variants (ASVs) from amplicon data https://benjjneb.github.io/dada2/index.html
...
Comparison Between V3V4 And Full-Length Sequencing Of 16S RRNA Genes (Specific mention of the full length primers used for PacBio) 
...
# Run DADA2
(A) derepFastq: Read in and dereplicate a fastq file.
Dereplication is a common step in many amplicon processing workflows. Instead of keeping 100 identical sequences and doing all 
downstream processing to all 100, you can keep/process one of them and just attach the number 100 to it. 
...
#Inspect errors: Agin the image issue
#plotErrors(err2)
...
print("DONE : Extract sample names from the filenames")
```


# Alternatively assign Taxonomy using DECIPHER
```{r}
